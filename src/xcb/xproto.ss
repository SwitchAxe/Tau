...
(define-ftype value_list-iterator
  (struct
    ...
    [rem int]
    [index int]))
(define-ftype rgb-iterator
  (struct
    [data (* rgb)]
    [rem int]
    [index int]))
(define-ftype coloritem-iterator
  (struct
    [data (* coloritem)]
    [rem int]
    [index int]))
(define-ftype segment-iterator
  (struct
    [data (* segment)]
    [rem int]
    [index int]))
...
(define-ftype value_list-iterator
  (struct
    ...
    [rem int]
    [index int]))
(define-ftype str-iterator
  (struct
    [data (* str)]
    [rem int]
    [index int]))
(define-ftype charinfo-iterator
  (struct
    [data (* charinfo)]
    [rem int]
    [index int]))
(define-ftype fontprop-iterator
  (struct
    [data (* fontprop)]
    [rem int]
    [index int]))
(define-ftype timecoord-iterator
  (struct
    [data (* timecoord)]
    [rem int]
    [index int]))
...
(define-ftype value_list-iterator
  (struct
    ...
    [rem int]
    [index int]))
(define-ftype clientmessagedata-iterator
  (struct
    [data (* clientmessagedata)]
    [rem int]
    [index int]))
(define-ftype setup-iterator
  (struct
    [data (* setup)]
    [rem int]
    [index int]))
(define-ftype setupauthenticate-iterator
  (struct
    [data (* setupauthenticate)]
    [rem int]
    [index int]))
(define-ftype setupfailed-iterator
  (struct
    [data (* setupfailed)]
    [rem int]
    [index int]))
(define-ftype setuprequest-iterator
  (struct
    [data (* setuprequest)]
    [rem int]
    [index int]))
(define-ftype screen-iterator
  (struct
    [data (* screen)]
    [rem int]
    [index int]))
(define-ftype depth-iterator
  (struct
    [data (* depth)]
    [rem int]
    [index int]))
(define-ftype visualtype-iterator
  (struct
    [data (* visualtype)]
    [rem int]
    [index int]))
(define-ftype format-iterator
  (struct
    ...
    [rem int]
    [index int]))
(define-ftype arc-iterator
  (struct
    [data (* arc)]
    [rem int]
    [index int]))
(define-ftype rectangle-iterator
  (struct
    [data (* rectangle)]
    [rem int]
    [index int]))
(define-ftype point-iterator
  (struct
    [data (* point)]
    [rem int]
    [index int]))
(define-ftype fontable-iterator
  (struct
    [data (* fontable)]
    [rem int]
    [index int]))
